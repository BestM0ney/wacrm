...
export interface Contact {
  ...
  /** WhatsApp routing identity (BSUID) for contacts who messaged from a
   *  username and so have no phone number. Migration 037. Stable — this
   *  is what sends are addressed to when `phone` is empty. */
  wa_id?: string | null;
  /** WhatsApp handle, stored without the leading @. Migration 038.
   *  Display only: users can rename themselves, so never dedupe or
   *  route on it. */
